...
/**
* Composable pour afficher une grille de films.
*
* Fonctionnalités :
* - Adapte le nombre de colonnes de la grille en fonction de la taille de l'écran.
* - Récupère la liste des films via le ViewModel lors de la composition.
* - Affiche chaque film avec une carte contenant l'affche, le nom et la date de sortie.
*
* Paramètres :
